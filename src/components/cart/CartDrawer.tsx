            ...
            items.map((item) => (
              <div key={item.product.id} className="flex gap-4">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <p className="text-xs text-pink-400 line-clamp-1">
                    {item.product.desc}
                  </p>
          ...
          <div className="p-6 border-t border-pink-100 space-y-4 bg-pink-50/50">
            ...
            <div className="p-3 bg-amber-50 rounded-xl border border-amber-100">
              <p className="text-[11px] text-amber-800 leading-relaxed text-center">
                ⏰ <strong>Os pedidos são feitos por encomenda.</strong> Após o contato,e informado o endereço de entrega, o prazo de entrega será acertado pelo WhatsApp.
              </p>
            </div>
